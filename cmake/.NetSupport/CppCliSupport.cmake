...
function(add_cpp_cli_library)
    ...
    set_target_properties ( ${pargs_TARGET}
		PROPERTIES
			DOTNET_TARGET_FRAMEWORK_VERSION ${DOT_NET_VERSION}
			COMMON_LANGUAGE_RUNTIME ""
			PROPERTY VS_GLOBAL_CLRSupport "true"
			PROPERTY VS_DOTNET_REFERENCES ${pargs_DOT_NET_REFERENCES}
    )
	
	#set_property(TARGET ${pargs_TARGET} PROPERTY VS_GLOBAL_CLRSupport "true")
...
endfunction(add_cpp_cli_library)
######################################################################
